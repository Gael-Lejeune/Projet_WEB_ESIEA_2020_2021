...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 10 mai 2021 à 18:01
...
(6, 3, 'Hades: Original Soundtrack', 10, 22, '\"Hades: Original Soundtrack\" by \"Darren Korb\"', 'Darren Korb', '2020-09-20', 'https://f4.bcbits.com/img/a2368914893_10.jpg'),
(7, 2, 'La fête est finie - EPILOGUE', 21, 18, '\"La fête est finie - EPILOGUE\" by \"Orelsan\"', 'Orelsan', '2018-11-15', 'https://static.fnac-static.com/multimedia/Images/FD/Comete/110926/CCP_IMG_ORIGINAL/1434387.jpg');
...
(8, 'oui', 'b2a5abfeef9e36964281a31e17b57c97', 'admin', 'lejeune.gael@free.fr', 'dqzdqzd', 'dzdq', '', 'dzqzdd');
...
ALTER TABLE `item_list`
  ADD CONSTRAINT `item_list_ibfk_4` FOREIGN KEY (`item_id`) REFERENCES `item` (`id_item`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `item_list_ibfk_5` FOREIGN KEY (`shipment_id`) REFERENCES `shipment` (`id_shipment`) ON DELETE CASCADE ON UPDATE CASCADE;
